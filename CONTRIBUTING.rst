...
Report bugs at https://github.com/./yolov8/issues
...
https://github.com/./yolov8/issues.
...
Ready to contribute? Here's how to set up `yolov8` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `yolov8` repo on GitHub. 
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/yolov8.git
